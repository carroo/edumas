...
class PengaduanController extends Controller
{
    ...
    {
        $this->middleware('masyarakat')->only('create','store','destroy');
    ...
    public function index()
    {
        ...
        return view('landingpage.pengaduan.index', compact('pengaduans'));
    }
    ...
    public function create()
    {
        ...
        return view('landingpage.pengaduan.create', compact('kategoris'));
    }
